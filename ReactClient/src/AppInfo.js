...
export default function AppInfo() {
    return (
        <div id='info-main-div'>
            ...
            <hr></hr>
            <p>1. The application sends your image to a server (a computer somewhere).</p>
            <p>2. The server feeds the image to an Object Detection Model (Machine Learning).</p>
            <p>3. Once the image has been proccessed by the Model, it sends the result image to cloud storage (another computer somewhere).</p>
